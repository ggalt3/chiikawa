	...
	case 0:
	{
		if (BeginTable("MiscTable", 2))
		{
			...
			TableNextColumn();
			{
				...
				if (Section("PixelFinder", 8))
				{
					FToggle(Vars::Misc::PixelFinder::Enabled, FToggleEnum::Left);
					FKeybind(Vars::Misc::PixelFinder::DrawLineKey, FButtonEnum::Right, { Vars::Menu::PrimaryKey[DEFAULT_BIND], Vars::Menu::SecondaryKey[DEFAULT_BIND] });
					FKeybind(Vars::Misc::PixelFinder::SavePointKey, FButtonEnum::Left, { Vars::Menu::PrimaryKey[DEFAULT_BIND], Vars::Menu::SecondaryKey[DEFAULT_BIND] });
					FKeybind(Vars::Misc::PixelFinder::ClearPointsKey, FButtonEnum::Right, { Vars::Menu::PrimaryKey[DEFAULT_BIND], Vars::Menu::SecondaryKey[DEFAULT_BIND] });
					FSlider(Vars::Misc::PixelFinder::DetectionStep, FSliderEnum::Left);
					FColorPicker(Vars::Misc::PixelFinder::PointColor, FColorPickerEnum::Right);
					FColorPicker(Vars::Misc::PixelFinder::SavedPointColor, FColorPickerEnum::Left);
					FColorPicker(Vars::Misc::PixelFinder::LineColor, FColorPickerEnum::Right);
				} EndSection();
			}
			/* Column 2 */
			TableNextColumn();
